# 臨場健康服務發現問題/風險 Profile - 臺灣勞工健康檢查交換實作指引 (Taiwan Labor Health Examination Exchange FHIR IG, TWHA IG) v0.10.1
...
* Refer to this Profile: [雇主端健康管理摘要 Composition Profile](StructureDefinition-TWHA-Composition-EmployerSummary.md) and [臨場健康服務建議與改善任務 Profile](StructureDefinition-TWHA-Task-ServiceTask.md)
...
本 Profile 之其他表示法： [CSV](../StructureDefinition-TWHA-Observation-ServiceFinding.csv), [Excel](../StructureDefinition-TWHA-Observation-ServiceFinding.xlsx), [Schematron](../StructureDefinition-TWHA-Observation-ServiceFinding.sch) 
