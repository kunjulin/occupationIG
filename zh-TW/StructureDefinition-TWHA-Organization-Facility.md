# 實施健康檢查之醫療機構 Profile - 臺灣勞工健康檢查交換實作指引 (Taiwan Labor Health Examination Exchange FHIR IG, TWHA IG) v0.10.2
...
本 Profile 之其他表示法： [CSV](../StructureDefinition-TWHA-Organization-Facility.csv), [Excel](../StructureDefinition-TWHA-Organization-Facility.xlsx), [Schematron](../StructureDefinition-TWHA-Organization-Facility.sch) 
