# 【本地 stub】嚼檳榔年值集（非權威定義） - 臺灣勞工健康檢查交換實作指引 (Taiwan Labor Health Examination Exchange FHIR IG, TWHA IG) v0.2.5

## ValueSet: 【本地 stub】嚼檳榔年值集（非權威定義） (實驗性) 
