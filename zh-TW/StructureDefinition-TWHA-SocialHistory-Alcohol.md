# 飲酒歷史與狀態 Profile - 臺灣勞工健康檢查交換實作指引 (Taiwan Labor Health Examination Exchange FHIR IG, TWHA IG) v0.10.1
...
* Examples for this Profile: [Observation/obs-alcohol](Observation-obs-alcohol.md)
...
本 Profile 之其他表示法： [CSV](../StructureDefinition-TWHA-SocialHistory-Alcohol.csv), [Excel](../StructureDefinition-TWHA-SocialHistory-Alcohol.xlsx), [Schematron](../StructureDefinition-TWHA-SocialHistory-Alcohol.sch) 
