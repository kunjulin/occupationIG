# 特別危害健康作業危害因子暴露史 Profile - 臺灣勞工健康檢查交換實作指引 (Taiwan Labor Health Examination Exchange FHIR IG, TWHA IG) v0.10.1
...
本 Profile 之其他表示法： [CSV](../StructureDefinition-TWHA-WorkExposure.csv), [Excel](../StructureDefinition-TWHA-WorkExposure.xlsx), [Schematron](../StructureDefinition-TWHA-WorkExposure.sch) 
