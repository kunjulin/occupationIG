# 遵從性與依賴 - 臺灣勞工健康檢查交換實作指引 (Taiwan Labor Health Examination Exchange FHIR IG, TWHA IG) v0.10.0
...
上開三項均為**本案專家會議之技術決議**，屬**受託團隊職權範圍， 無須委託單位或主管機關另行核定**。🔴 **更正（v0.10.0）**：本表於 v0.6.0–v0.9.3 期間記為「**已獲主管機關答覆**」， **該敘述不實——國民健康署迄未就此作成函復**。 「經主管機關確認」是規範文件裡效力最強的措辭之一，誤用會使該署日後讀到與事實不符。 全庫同型敘述經逐處更正。⚠️ **仍屬國民健康署權責者**：21 列清單本身之**法定效力**、**正式公告內容與生效時點**。
