# 特殊健檢實驗室檢驗 Profile - 臺灣勞工健康檢查交換實作指引 (Taiwan Labor Health Examination Exchange FHIR IG, TWHA IG) v0.10.0
...
本 Profile 之其他表示法： [CSV](../StructureDefinition-TWHA-LabResult-Special.csv), [Excel](../StructureDefinition-TWHA-LabResult-Special.xlsx), [Schematron](../StructureDefinition-TWHA-LabResult-Special.sch) 
