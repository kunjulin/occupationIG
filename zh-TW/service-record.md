# Service Record - 臺灣勞工健康檢查交換實作指引 (Taiwan Labor Health Examination Exchange FHIR IG, TWHA IG) v0.2.3
...
> 範例：[現場發現問題 example-service-finding](Observation-example-service-finding.md)、[改善建議任務 example-service-task](Task-example-service-task.md)；完整封包見 [UC-006](Bundle-UC-006.md)。 - 透過 Composition 封裝，達成「本次改善建議」與「前次建議追蹤」的歷史關聯性。
