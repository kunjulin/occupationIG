# 勞動部通報報告代碼值集 - 臺灣勞工健康檢查交換實作指引 (Taiwan Labor Health Examination Exchange FHIR IG, TWHA IG) v0.10.0

## ValueSet: 勞動部通報報告代碼值集 (實驗性) 

 
【依據：勞工健康保護規則附表】包含勞動部通報報告類別代碼之值集。（provisional，隨 CS-LaborReportCode 待官方確認） 
