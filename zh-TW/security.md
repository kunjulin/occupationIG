# Security - 臺灣勞工健康檢查交換實作指引 (Taiwan Labor Health Examination Exchange FHIR IG, TWHA IG) v0.2.4
...
以上三者之落地屬「雇主端資料隔離之實作機制」範疇，統一登記於 [未決事項 M-10](open-issues.md#m-10)。實作端在該項定案前，應依《個資法》與衛福部規範 自行處理，並保留可日後對接之欄位。
