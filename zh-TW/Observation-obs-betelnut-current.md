# 嚼檳榔狀態與量化資料範例（現嚼，含情境欄位） - 臺灣勞工健康檢查交換實作指引 (Taiwan Labor Health Examination Exchange FHIR IG, TWHA IG) v0.5.0
...
> **component****code**: 嚼食年數**value**: 20 年 (Details: UCUM codea = 'a')
