# 【本地 stub】嚼檳榔年代碼系統（非權威定義） - 臺灣勞工健康檢查交換實作指引 (Taiwan Labor Health Examination Exchange FHIR IG, TWHA IG) v0.2.5

## CodeSystem: 【本地 stub】嚼檳榔年代碼系統（非權威定義） (實驗性) 

 
Betel Nut Chewing Year Code System 

下列值集之定義引用本代碼系統：

* [SFBetNutChewYearValueSet](ValueSet-sf-BetNutChewYear-valueset.md)
