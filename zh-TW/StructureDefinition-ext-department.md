# 部門/課別擴充 - 臺灣勞工健康檢查交換實作指引 (Taiwan Labor Health Examination Exchange FHIR IG, TWHA IG) v0.10.3

## 擴充: 部門/課別擴充 

【技術規格】記錄受檢勞工於事業單位中所屬之部門、課別或課室名稱。
...
Simple Extension with the type string: 【技術規格】記錄受檢勞工於事業單位中所屬之部門、課別或課室名稱。
...
```json
{
  ...
  "differential" : {
    "element" : [{
      ...
      "path" : "Extension",
      "short" : "部門/課別擴充",
      "definition" : "【技術規格】記錄受檢勞工於事業單位中所屬之部門、課別或課室名稱。"
    },
    {
