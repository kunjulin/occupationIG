# 戒除時間（戒菸/戒檳榔月數）擴充 - 臺灣勞工健康檢查交換實作指引 (Taiwan Labor Health Examination Exchange FHIR IG, TWHA IG) v0.10.2

## 擴充: 戒除時間（戒菸/戒檳榔月數）擴充 

【主管機關：國民健康署】記錄受檢者已戒菸或已戒檳榔的月數。
...
Simple Extension with the type integer: 【主管機關：國民健康署】記錄受檢者已戒菸或已戒檳榔的月數。
...
```json
{
  ...
  "differential" : {
    "element" : [{
      ...
      "definition" : "【主管機關：國民健康署】記錄受檢者已戒菸或已戒檳榔的月數。"
    },
    {
