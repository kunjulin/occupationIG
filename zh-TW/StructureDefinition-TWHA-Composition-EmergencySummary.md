# 職業健康急診友善摘要 Composition Profile - 臺灣勞工健康檢查交換實作指引 (Taiwan Labor Health Examination Exchange FHIR IG, TWHA IG) v0.10.3

## 資源 Profile: 職業健康急診友善摘要 Composition Profile 

 
【技術規格】職業健康急診友善摘要（Occupational Health Emergency Summary）。當勞工於急診就醫時，供急診醫師快速掌握其特別危害作業暴露史、關鍵生命徵象與檢驗值、以及健康管理分級。以 Composition 承載，將既有之暴露史（TWHA-WorkExposure）、生命徵象、CBC／肝腎功能等關鍵檢驗與總評分級以 section.entry 引用。 
...
本 Profile 之其他表示法： [CSV](../StructureDefinition-TWHA-Composition-EmergencySummary.csv), [Excel](../StructureDefinition-TWHA-Composition-EmergencySummary.xlsx), [Schematron](../StructureDefinition-TWHA-Composition-EmergencySummary.sch) 
