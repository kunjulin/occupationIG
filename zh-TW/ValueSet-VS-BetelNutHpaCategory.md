# 口腔黏膜檢查表嚼檳榔習慣級距值集 - 臺灣勞工健康檢查交換實作指引 (Taiwan Labor Health Examination Exchange FHIR IG, TWHA IG) v0.4.0

## ValueSet: 口腔黏膜檢查表嚼檳榔習慣級距值集 (實驗性) 

 
包含口腔黏膜檢查表（107/7 修訂）嚼檳榔習慣六個級距之值集。（provisional，隨 CS-BetelNutHpaCategory） 
