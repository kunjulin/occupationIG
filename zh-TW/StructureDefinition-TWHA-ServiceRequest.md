# 健康檢查健檢追蹤檢查要求 Profile - 臺灣勞工健康檢查交換實作指引 (Taiwan Labor Health Examination Exchange FHIR IG, TWHA IG) v0.10.2

## 資源 Profile: 健康檢查健檢追蹤檢查要求 Profile 

 
【技術規格】針對第三級或需要追蹤之勞工，醫師開立之追蹤檢查或現場評估排程要求，繼承自 TW Core ServiceRequest。 
