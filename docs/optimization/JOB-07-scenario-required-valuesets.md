...
### 7.5 逐項核對 PDF 後浮現之兩項界定問題（登記為 M-11）

以 `docs/regulations/` 之附表九／附表十 PDF **逐項核對**已落地值集（非轉抄 markdown），
發現兩件須外部認定、不宜片面決定之事，已登記未決事項
[M-11](../../input/pagecontent/open-issues.md) 並於相關值集之 description 交叉註記：

1. **「法定應執行」之範疇**：附表十 PDF 本文對多數危害作業僅列高階項目——例如二硫化碳
   作業本文僅列 ALT／γ-GT ＋心電圖，**未列尿中 TTCA**；鉛作業本文僅列血中鉛，**未列**
   尿中鉛／共聚卟啉／δ-ALA。本 IG 之家族專屬值集納入這些尿中生物偵測項，係採**職安署
   特殊健檢細項**之口徑（經 `special-exam.md` 涵蓋表歸屬至危害家族），非逐字取自附表十本文。
   兩種口徑對「是否做齊」之稽核結果不同。**此為 §4 所指之法規解釋爭議，依規定登記而非逕行認定。**

2. **法規版本落差**：repo 內附表九／附表十 PDF 為**修正前版本**（附表十 32 項、附表九第(5)項
   無 RBC／MCV）。本 IG 依 **115.06.26 修正**編碼（附表十 35 項、附表九增列 RBC／MCV），
   但修正版 PDF **未納入 repo**，該批新增項目無 repo 內原文可逐項核對——本次能逐項核對者，
   限於 PDF 涵蓋之範圍。

> ⚠️ 此發現印證 CLAUDE.md §常犯錯誤「憑既有 markdown 表格轉抄法規項目」之風險：
> 若未回到 PDF 逐項核對，這兩項界定問題不會浮現。噪音／粉塵兩家族之值集與附表十本文
> **完全一致**；鉛／有機溶劑兩家族之值集**超出**附表十本文（納入職安署細項），
> 此差異若不揭露，審查者無從判斷值集之權威層級。
