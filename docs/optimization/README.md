...
| [JOB-23](JOB-23-navigation-alignment-twcore.md) | 導覽列（頁籤內容與順序）比照 TW Core IG v1.0.0：五項結構性差異＋`artifacts.html#1~#4` 位移型錨點缺陷 | **P1**（錨點項屬 P0 性質） | 資訊架構／發佈呈現 | S–M（1.5–2 人日） | 無（JOB-12 §1(1) 由本 JOB 之 R-5 承接） | 📋 **評估完成，待核准後實作**（v0.2.2 為評估產物；實作另以 v0.2.3 發佈）。緣起：2026-08-16 主管指示。建議 A 類採納 7 項、B 類不採納 4 項（不改檔名、不刪快速入門／未決事項）、C 類後評 2 項 |
