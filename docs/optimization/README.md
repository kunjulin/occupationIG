...
| [JOB-20](JOB-20-t12-scale-parts-resolution.md) | T-12 結案：Scale 未對映之三個 part 代碼查證與稽核範圍調整（`LP32888-7`=Doc／`LP436123-6`=SemiQn／`LP7747-1`=-） | **P1** | 術語正確性／工程 | S（0.5 人日） | JOB-19 及其補充 | ⬜ 未執行（外部查證已取得，見該檔 §2） |
