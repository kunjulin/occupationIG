...
// =================================================================
// 3. v3.0 Core 重構移入項目 (Moved from VS-CoreDataset — Wave 2)
//    文件一/二 v3.0：Core = 主管機關最小上傳集(21列)。以下為原 Core 之
//    非上傳檢驗碼(CBC/ALT/eGFR/HbA1c/腫瘤標記/尿沉渣/糞便/甲狀腺/傳染病等)，
//    依「不刪碼、只移層」原則自 VS-CoreDataset 移入。代碼未從系統刪除，僅改層。
// =================================================================
