...
* #duration-years "嚼食持續期間" "嚼食檳榔之持續期間（嚼了多久），以 UCUM 單位「a」或「mo」表達，並以原始採集粒度為準——不得將「嚼 2 年」逕行改寫為 24 個月。承載主管機關最小上傳集第 11 列（醫令 30907X-3「嚼檳月數」）：該欄名與吸菸列之「戒菸月數」形式對稱，易被讀成「戒檳月數」，經委託單位（工業技術研究院）2026-08-21 指示確認其語意為嚼食持續期間而非戒檳月數；該單位並表明本項非國民健康署需確認事項。對應上游 sf-BetNutChewBeh#year。⚠️ 代碼 id 保留「duration-years」係因該碼已於 v0.4.0 發佈，改名屬破壞性變更；真實語意以本顯示名與定義為準。"
