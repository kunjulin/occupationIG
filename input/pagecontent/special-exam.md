...
> **第一期範疇說明（議題 5 / C-04）**：第一期以**噪音／鉛／粉塵**三模組為結構化必驗項目（收錄於 [VS-OccHealthCheck-Required](ValueSet-VS-OccHealthCheck-Required.html) 草案），並以 `TWHA-HearingTest`、`TWHA-LabResult-Special`、`TWHA-PulmonaryFunction` 等 Profile 個別建模。其餘附表十危害作業於第一期以 `TWHA-LabResult-Special` 通用承載（收錄於 `VS-ExtendedDataset`），尚未個別結構化，待後續期別依需求擴充。
>
> **共用／專屬解耦**：附表十以作業類別分列，項目高度重疊（多數作業共用 ALT、Creatinine、尿液、CBC 等）。本 IG 以 Core（`VS-CoreDataset`）承載共用項目，危害專屬項目以 `TWHA-LabResult-Special` 及專屬 Profile 承載，並以 `ext-hazard-type` 標記作業類別。

## 附表十 35 項法定作業涵蓋度對照（歸併為 12 危害家族） (Coverage Audit)

下表以《勞工健康保護規則》**附表十（115.06.26 修正）所列 35 項**特別危害健康作業為列主鍵（編號 1–35），逐項標註對應之本 IG `CS-HazardType` **12 危害家族**、代表性專屬檢查項目與承載方式。附表十編號 → 危害家族之完整對映另建置於 [ConceptMap Appendix10-to-HazardType](ConceptMap-Appendix10-to-HazardType.html)；家族代碼集見 [CS-HazardType](CodeSystem-CS-HazardType.html)、附表十作業代碼集見 [CS-Appendix10Operation](CodeSystem-CS-Appendix10Operation.html)。「共用項目」收錄於 Core（`VS-CoreDataset`），「專屬項目」收錄於 `VS-ExtendedDataset`；★ 為第一期已結構化必驗模組。
...
| 附表十編號 | 法定作業名稱 | 危害家族 (CS-HazardType) | 代表專屬項目（LOINC／Profile） | 本 IG 承載 |
|:--|:--|:--|:--|:--|
| 1 | 高溫作業 | `high-temp` | 心電圖 `11524-6`、電解質 Na/K/Cl、BUN `3094-0`、eGFR `88293-6`、尿比重 `5810-7` | ✓ |
| 2 ★ | 噪音作業 | `noise` | 純音聽力 Panel `89015-2`（0.5–8 kHz 雙耳 14 碼）/ `TWHA-HearingTest` | ✓ |
| 3 | 游離輻射作業 | `radiation` | CBC＋白血球分類、TSH `11580-8`／Free T4 `3024-7`、皮膚/眼晶體（理學） | ✓ |
| 4 | 異常氣壓作業 | `abnormal-pressure` | 肺功能 `19876-2`/`20150-9`/`19926-5`、長骨 X 光 `24579-5`、心電圖 `11524-6`、聽力 | ✓ |
| 5 ★ | 鉛作業 | `lead` | 血中鉛 `5671-3`（Acc `23749-5`）、尿中鉛 `5676-2`、Copro `11212-8`、ALA `11215-1`、CBC | ✓ |
| 6 | 四烷基鉛作業 | `tetraalkyl-lead` | 尿中鉛/Copro/ALA、神經精神（理學） | ✓ |
| 7 | 1,1,2,2-四氯乙烷作業 | `organic-solvent` | 肝功能 ALT/γ-GT `2324-2`、腎功能 | ✓ |
| 8 | 四氯化碳作業 | `organic-solvent` | 肝腎功能 | ✓ |
| 9 | 二硫化碳作業 | `organic-solvent` | 尿中 TTCA `12533-6`、心電圖 `11524-6`、眼底（理學）、血脂 | ✓ |
| 10 | 三氯乙烯作業 | `organic-solvent` | 尿中三氯乙酸 `3041-1`、肝功能 | ✓ |
| 11 | 二甲基甲醯胺（DMF）作業 | `organic-solvent` | 尿中 N-甲基甲醯胺 `12543-5`、肝功能 | ✓ |
| 12 | 正己烷作業 | `organic-solvent` | 尿中 2,5-己二酮 `31170-4`、神經學 | ✓ |
| 13 | 聯苯胺及其鹽類作業 | `specific-chemical` | 尿中聯苯胺 `10909-0`、尿液細胞學/尿潛血 | 部分（尿液細胞學待補） |
| 14 | 鈹及其化合物作業 | `specific-chemical` | 胸部 X 光 `36643-5`、肺功能、皮膚（理學） | ✓（鈹無定量 LOINC） |
| 15 | 氯乙烯作業 | `specific-chemical` | 肝功能、腹部超音波 `24558-9`、手部 X 光 | 部分（手部 X 光待補） |
| 16 | 苯作業 | `specific-chemical` | CBC＋分類、尿中酚 `2758-1`、尿中 t,t-黏康酸 `72665-3` | ✓ |
| 17 | 2,4-二異氰酸甲苯（TDI）作業 | `specific-chemical` | 肺功能、胸部 X 光 `36643-5`、呼吸道（理學） | ✓ |
| 18 | 石綿作業 | `specific-chemical` | 胸部 X 光 `36643-5`（胸膜）、肺功能 | ✓ |
| 19 | 砷及其化合物作業 | `specific-chemical` | 尿中無機砷 `5586-3`、皮膚/鼻中膈（理學） | ✓ |
| 20 | 錳及其化合物作業 | `specific-chemical` | 血錳 `5681-2`/尿錳 `42221-2`、神經學 | ✓ |
| 21 | 黃磷作業 | `yellow-phosphorus` | 下顎骨 X 光 `24829-4`、血清磷 `2777-1`、肝功能 | ✓ |
| 22 | 聯吡啶或巴拉刈作業 | `paraquat` | 尿中巴拉刈 `9827-7`、肺功能、胸部 X 光 `36643-5` | ✓ |
| 23 ★ | 粉塵作業 | `dust` | 胸部 X 光 `36643-5`、肺功能 FVC/FEV1 | ✓ |
| 24 | 鉻酸及其鹽類作業 | `specific-chemical` | 血鉻 `5622-6`/尿鉻 `5623-4`、鼻中膈（理學） | ✓ |
| 25 | 鎘及其化合物作業 | `specific-chemical` | 血鎘 `5609-3`/尿鎘 `5611-9`、腎功能、肺功能 | ✓ |
| 26 | 鎳及其化合物作業 | `specific-chemical` | 尿中鎳 `14099-6`、eGFR `88293-6`、呼吸道（理學） | ✓ |
| 27 | 乙基汞化合物作業 | `specific-chemical` | 血汞 `5685-3`、eGFR `88293-6`、神經學 | ✓ |
| 28 | 溴丙烷作業 | `specific-chemical` | 神經學、CBC、肌肉骨骼（理學） | ✓ |
| 29 | 1,3-丁二烯作業 | `specific-chemical` | CBC＋白血球分類 | ✓ |
| 30 | 甲醛作業 | `specific-chemical` | 尿中甲醛 `5653-1`、CBC、呼吸道/皮膚（理學） | ✓ |
| 31 | 銦及其化合物作業 | `specific-chemical` | 血清銦 `60090-8`/血中銦 `5665-5`、肺功能 | ✓ |
| 32 | 汞及其無機化合物作業 | `specific-chemical` | 血汞 `5685-3`/尿汞 `5689-5`、eGFR `88293-6`、神經學 | ✓ |
| 33 | 苯乙烯作業 | `organic-solvent` | 尿中扁桃酸 `13000-5`、肝腎功能 | ✓（115.06.26 新增） |
| 34 | 甲苯作業 | `organic-solvent` | 尿中馬尿酸 `6709-0`、肝腎功能 | ✓（115.06.26 新增） |
| 35 | 二甲苯作業 | `organic-solvent` | 尿中甲基馬尿酸 `2725-0`、eGFR `88293-6` | ✓（115.06.26 新增） |

> **臨床適當性註記**：(1) 噪音純音聽力圖為 0.5–8 kHz 雙耳 14 個氣導聽閾 LOINC 代碼（`89015-2` panel 成員）；院內/職醫另用之 `21104-5` 系列列為 Acceptable 變異碼。(2) FEV1 正確 LOINC 為 `20150-9`。(3) **eGFR（腎絲球過濾率）**：115.06.26 修正於高溫、鎳、乙基汞、汞及其無機化合物、二甲苯等類別新增，本 IG 以 `88293-6`（CKD-EPI 2021，Core 已收）承載，MDRD `33914-3` 為 Acceptable。(4) 手部 X 光（氯乙烯）、尿液細胞學（聯苯胺類）目前以通用承載，代碼結構化待後續期別補齊。(5) 鈹之生物偵測無公認定量 LOINC，以定性/理學評估記錄。
