...
> 其展開結果與本表之 21 列**計的不是同一件事**：前者是 FHIR 值集之成員代碼數，
> 後者是主管機關原案之欄位列數。現存差異為兩處：
>
> | 差異 | 說明 |
> |:--|:--|
...
**三項差異已依本案專家會議決議定案**（見〈委員意見與決議紀錄〉v3.7 議題 16，並經共同主持人曹又中主任 2026-07-31 回信補充說明）：
...
> 無須委託單位或主管機關另行核定**。
>
> 🔴 **更正（v0.10.0）**：本表於 v0.6.0–v0.9.3 期間記為「**已獲主管機關答覆**」，
> **該敘述不實——國民健康署迄未就此作成函復**。
