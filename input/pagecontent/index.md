...
> **本指引為研擬中之草案，尚未定稿。** 以下六點是試用前必須知道的事項——
> 它們說明**哪些內容日後會變**，請在投入開發前一併評估。
...
> 各項之完整背景、決定者與處置規則，見本專案 GitHub 之
> [〈已知限制與待決事項〉](https://github.com/kunjulin/occupationIG/blob/main/docs/known-limitations.md)。
...
> 決策所需輸入與影響範圍見[未決事項 M-5](index.html#before-you-start)。
